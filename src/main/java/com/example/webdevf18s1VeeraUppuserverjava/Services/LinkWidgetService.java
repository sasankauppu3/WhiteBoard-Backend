...
import com.example.webdevf18s1VeeraUppuserverjava.Repositories.LinkWidgetRepository;
...
public class LinkWidgetService{
	...
	@Autowired
	LinkWidgetRepository wr;

	@PostMapping("/api/topic/{tid}/link/widget")
	public List<Widget> createWidget(@PathVariable("tid")int tid, LinkWidget widget) {
	...
	public Widget updateWidget(@PathVariable("wid")int wid, @RequestBody LinkWidget widget) {

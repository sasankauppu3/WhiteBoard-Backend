...
import com.example.webdevf18s1VeeraUppuserverjava.Repositories.ListWidgetRepository;
@RestController
...
public class ListWidgetService{
	...
	@Autowired
	ListWidgetRepository wr;

	@PostMapping("/api/topic/{tid}/list/widget")
	public List<Widget> createWidget(@PathVariable("tid")int tid, ListWidget widget) {
	...
	public Widget updateWidget(@PathVariable("wid")int wid, @RequestBody ListWidget widget) {
